 ...
 * #L%
 */
package hu.icellmobilsoft.quarkus.sampler.api.test;
...
/**
 * REST endpoint for Sampler Service
 *
 * @author speter555
 * @since 0.1.0
 */
@Path(QuarkusSamplerPath.TEST_QUARKUS_SAMPLER_SERVICE)
@Tag(name = ITestQuarkusSamplerServiceRest.TAG, description = "REST endpoints for test operations.")
public interface ITestQuarkusSamplerServiceRest {
    ...
    @Produces(value = { MediaType.APPLICATION_JSON, MediaType.TEXT_XML, MediaType.APPLICATION_XML })
    SampleResponse postTest(@ValidateXML(xsdPath = "xsd/hu/icellmobilsoft/quarkus/sampler/dto/super.xsd") BaseRequest baseRequest,
            @QueryParam(QuarkusSamplerPath.PARAM_TEST_STRING) @Parameter(name = QuarkusSamplerPath.PARAM_TEST_STRING,
                    description = TEST_DESCRIPTION) String testString,
            @QueryParam(QuarkusSamplerPath.PARAM_TEST_INTEGER) @Parameter(name = QuarkusSamplerPath.PARAM_TEST_INTEGER,
                    description = TEST_DESCRIPTION) Integer testInteger,
