...
/**
 * IT tests for {@link IJavaBaseTypesRest#postInsertJavaBaseTypesEntityWithBatchService}.
 *
 * @author csaba.balogh
 * @since 2.0.0
 */
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
@DisplayName("Testing JavaBaseTypesRest.postInsertJavaBaseTypesEntityWithBatchService()")
@Tag(TestSuiteGroup.RESTASSURED)
class PostInsertJavaBaseTypesEntityWithBatchServiceIT extends BaseJavaBaseTypesRestIT {

    @Test
    @Order(1)
    void postInsertJavaBaseTypesEntityWithBatchServiceWithEmptyJavaBaseTypesTest() throws BaseException {
        // given
        JavaBaseTypesInsertType expectedJavaBaseTypes = new JavaBaseTypesInsertType();

        // when
        JavaBaseTypesResponse response = createJavaBaseTypes(expectedJavaBaseTypes);
        ...
        Assertions.assertAll(
                ...
                () -> Assertions.assertNotNull(actualJavaBaseTypes.getJavaBaseTypesId(), "javaBaseTypesId"));
    }

    @Test
    @Order(2)
    void postInsertJavaBaseTypesEntityWithBatchServiceWithFilledJavaBaseTypesTest() throws BaseException {
        // given
        JavaBaseTypesInsertType expectedJavaBaseTypes = new JavaBaseTypesInsertType();
